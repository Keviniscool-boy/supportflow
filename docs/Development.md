...
| --- | --- | --- | --- | --- |
| `T-001` | Go 模块与目录骨架 | 无 | Go 1.24+ 模块、模块边界、基础 `go test ./...` 可执行 | 待开始 |
| `T-002` | 配置与环境 Profile | T-001 | Development/Lite/Production-like 配置分层；密钥只来自环境或 Secret Reference | 待开始 |
| `T-003` | PostgreSQL Migration Runner | T-001、T-002 | 顺序 Migration、版本表、失败停止、空库可初始化 | 待开始 |
...
| `T-006` | HTTP 基础中间件 | T-001、T-002 | Request ID、JSON 错误 Envelope、Content-Type、Body 限制、稳定错误码 | 待开始 |
