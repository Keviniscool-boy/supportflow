...
| `T-008` | 日志与 OpenTelemetry 接入边界 | T-001、T-006 | `slog` 输出 stdout；敏感字段脱敏；Trace 与系统日志不混表 | 已完成 |
...
| `T-102` | Conversation 与 Message Service | T-004、T-009、T-101 | 会话创建、消息顺序、脱敏、分页和对象归属测试通过 | 已完成 |
